...
public class Example2
{
    public static void main( String args[] )
    {
        ...
        try
        {
            ...
            InputStream input= Example2.class.getClassLoader().getResourceAsStream("velocity/example1/velocity.properties");
            props.load(input);
        ...
        try
        {
            Velocity.mergeTemplate("velocity/example1/example2.vm", "ISO-8859-1", context, w );
        }
        catch (Exception e )
        {
